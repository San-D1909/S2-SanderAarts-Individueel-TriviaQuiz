...
namespace ScoreboardManager.Business
{
    public class ScoreboardContainer
    {
        ...
        {
            Data.SubmitDTO submitDTO = new Data.SubmitDTO{ Category = category,Difficulty = difficulty,Question_Amount = question_Amount,Question_List = question_List,Unique_ID = unique_ID,Score= finalScore };
